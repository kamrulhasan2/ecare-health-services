            ...
            <form id="ecare-caregiver-registration-form" class="ecare-form ecare-form-registration" style="background:#fff;padding:30px;border-radius:12px;border:1px solid var(--border-light);box-shadow:var(--shadow-md);" enctype="multipart/form-data" novalidate>
                ...
                <div class="ecare-form-row">
                    <div class="ecare-form-field">
                        ...
                        <div class="ecare-password-wrap">
                            <input type="password" name="password" placeholder="••••••••" required />
                            <button type="button" class="ecare-password-toggle" aria-pressed="false" aria-label="<?php esc_attr_e('Show password', 'ecare-health-services'); ?>" title="<?php esc_attr_e('Show password', 'ecare-health-services'); ?>">
                                <svg class="ecare-eye ecare-eye-show" viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
